...
urlpatterns = [
    ...
    path('expense/all_filter_page', all_filter_page),
    ...
    path('expense/approval_update', approval_update),
    path('expense/approval_status', approval_status),
    path('expense/approval_list', approval_list),
