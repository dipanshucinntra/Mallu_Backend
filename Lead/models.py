...
class Lead(models.Model):
    ...
    productInterest = models.TextField(blank=True)
    ...
    AssignedDate = models.CharField(max_length=60, blank=True)
    ###########################Added#################################
    junk_by = models.CharField(max_length=60, blank=True)
    junk_timestamp = models.CharField(max_length=60, blank=True)
